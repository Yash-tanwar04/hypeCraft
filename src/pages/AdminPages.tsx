  ...
  const handleSaveProject = async (e: React.FormEvent) => {
    ...
    if (editingProject.id) {
      ...
      await createProject({
        ...
        heroImage: editingProject.heroImage || '/images/political_pr_hero_1786300910145.jpg',
  ...
  const handleSaveInsight = async (e: React.FormEvent) => {
    ...
    if (editingInsight.id) {
      ...
      await createInsight({
        ...
        coverImage: editingInsight.coverImage || '/images/case_study_warroom_1786301027509.jpg',
